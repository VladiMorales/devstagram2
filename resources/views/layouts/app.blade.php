...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Con la directiva de stack puedes poner hojas de estilos diferentes en cada pagina --}}
        @stack('styles')
        <title>Desvstagram - @yield('titulo')</title>
                ...
                @auth
                  ...
                  <nav class="flex gap-2 items-center">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                      {{-- @csrf evita que aparezca el error de pagina expirada --}}
                      @csrf
